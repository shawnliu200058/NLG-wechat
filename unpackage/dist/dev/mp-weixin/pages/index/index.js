...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 34));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
try {
  components = {
    uniNoticeBar: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-notice-bar/components/uni-notice-bar/uni-notice-bar */ "uni_modules/uni-notice-bar/components/uni-notice-bar/uni-notice-bar").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-notice-bar/components/uni-notice-bar/uni-notice-bar.vue */ 116))
    },
    uniFab: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-fab/components/uni-fab/uni-fab */ "uni_modules/uni-fab/components/uni-fab/uni-fab").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-fab/components/uni-fab/uni-fab.vue */ 123))
    }
  }
} catch (e) {
  if (
...
var _home = __webpack_require__(/*! ../../api/home.js */ 27);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _createNamespacedHelp = (0, _vuex.createNamespacedHelpers)('category'),mapActions = _createNamespacedHelp.mapActions;var CarouselList = function CarouselList() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/carouselList */ "pages/index/cpns/carouselList").then((function () {return resolve(__webpack_require__(/*! ./cpns/carouselList.vue */ 130));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var Category = function Category() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/category */ "pages/index/cpns/category").then((function () {return resolve(__webpack_require__(/*! ./cpns/category.vue */ 137));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var RecommendedViewList = function RecommendedViewList() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/recommededView */ "pages/index/cpns/recommededView").then((function () {return resolve(__webpack_require__(/*! ./cpns/recommededView.vue */ 144));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
